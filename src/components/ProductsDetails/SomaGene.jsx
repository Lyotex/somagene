        ...
        <div className="max-w-screen-xl container mx-auto px-2">
          ...
          <div className="w-full">
            ...
            <div className="mt-20">
              ...
              <p className="text-sm">
                White or almost white lyophilized powder filled in a vial and a
                colorless and transparent liquid preparation when dissolved in
                accompanying solvent.
              </p>
              <p className="text-sm">
                1V: [vial(4IU) x 1 pc. + accompanying solvent(1mL) x 1 pc.]/box
              </p>
              <p className="text-sm">
                5V: [vial(4IU) x 5 pcs. + accompanying solvent(1mL) x 5
                pcs.]/box
              </p>
